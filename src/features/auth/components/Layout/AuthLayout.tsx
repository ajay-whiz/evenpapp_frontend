...
const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  return (
    ...
    <div className="min-h-screen flex bg-no-repeat font-sans backdrop-blur-md bg-purple-600 bg-cover" style={{ backgroundImage: "url('/assets/images/bg.png')" }}> 
      <div className="container 2xl:px-80 xl:px-52 flex justify-center items-center ">
        <div className="grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 ">
      {/* Left: Form Area */}
      <div className="w-full  flex flex-col justify-left px-8 sm:px-16 md:px-8 lg:px-8 bg-white mt-autoshadow-md ">
      ...
      {/* Right: Illustration */}
      <div
        className="hidden md:flex shadow-md bg-blue-600 text-white flex-col items-center justify-center px-12 relative bg-no-repeat bg-cover bg-center"
